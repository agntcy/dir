...
# Assuming these would be generated by protoc for Python
from client.proto.core.v1alpha1 import object_pb2
from client.proto.routing.v1alpha1 import routing_service_pb2
from client.proto.routing.v1alpha1 import routing_service_pb2_grpc
from client.proto.store.v1alpha1 import store_service_pb2_grpc
...
class Client:
    def __init__(self, config: Config):
        ...
        self.store_client = store_service_pb2_grpc.StoreServiceStub(channel)
        self.routing_client = routing_service_pb2_grpc.RoutingServiceStub(channel)
    ...
    def publish(self, ref: object_pb2.ObjectRef, network: bool = False, metadata: Optional[List[Tuple[str, str]]] = None) -> None:
        ...
        try:
            self.routing_client.Publish(
                routing_service_pb2.PublishRequest(record=ref, network=network),
                metadata=metadata
            )
        except Exception as e:
            raise Exception(f"Failed to publish object: {e}")

    def list(self, req: routing_service_pb2.ListRequest, metadata: Optional[List[Tuple[str, str]]] = None) -> Iterator[routing_service_pb2.ListResponse.Item]:
    ...
    def unpublish(self, ref: object_pb2.ObjectRef, network: bool = False, metadata: Optional[List[Tuple[str, str]]] = None) -> None:
        ...
        try:
            self.routing_client.Unpublish(
                routing_service_pb2.UnpublishRequest(record=ref, network=network),
                metadata=metadata
            )
        except Exception as e:
            raise Exception(f"Failed to unpublish object: {e}")

    def push(self, ref: object_pb2.ObjectRef, reader: BinaryIO, metadata: Optional[List[Tuple[str, str]]] = None) -> object_pb2.ObjectRef:
        ...
        try:
            ...
            def request_iterator():
                while True:
                    ...
                    obj = object_pb2.Object(ref=ref, data=data)
                    yield obj
    ...
    def pull(self, ref: object_pb2.ObjectRef, metadata: Optional[List[Tuple[str, str]]] = None) -> io.BytesIO:
    ...
    def lookup(self, ref: object_pb2.ObjectRef, metadata: Optional[List[Tuple[str, str]]] = None) -> object_pb2.ObjectRef:
    ...
    def delete(self, ref: object_pb2.ObjectRef, metadata: Optional[List[Tuple[str, str]]] = None) -> None:
