...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_AGENT']._serialized_end=535
  _globals['_AGENT_ANNOTATIONSENTRY']._serialized_start=473
  _globals['_AGENT_ANNOTATIONSENTRY']._serialized_end=535
