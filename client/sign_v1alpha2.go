...
import (
	...
	coretypes "github.com/agntcy/dir/api/core/v1alpha2"
...
func (c *Client) SignOIDCv2(ctx context.Context, req *signtypes.SignOIDCRequest) (*signtypes.SignOIDCResponse, error) {
	// Validate request.
	...
	signedAgent, err := c.Signv2(ctx, req.GetRecord(), signKeypair, signOpts)
...
func (c *Client) SignWithKeyv2(ctx context.Context, req *signtypes.SignWithKeyRequest) (*signtypes.SignWithKeyResponse, error) {
	...
	signedAgent, err := c.Signv2(ctx, req.GetRecord(), signKeypair, sign.BundleOptions{})
...
func (c *Client) Signv2(_ context.Context, agent *coretypes.Record, signKeypair sign.Keypair, signOpts sign.BundleOptions) (*coretypes.Record, error) {
