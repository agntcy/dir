...
const (
	...
	RepositoryService_ListRepositoryRecords_FullMethodName = "/saas.v1alpha1.RepositoryService/ListRepositoryRecords"
...
type RepositoryServiceClient interface {
	...
	ListRepositoryRecords(ctx context.Context, in *ListRepositoryRecordsRequest, opts ...grpc.CallOption) (*ListRepositoryRecordsResponse, error)
...
func (c *repositoryServiceClient) ListRepositoryRecords(ctx context.Context, in *ListRepositoryRecordsRequest, opts ...grpc.CallOption) (*ListRepositoryRecordsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListRepositoryRecordsResponse)
	err := c.cc.Invoke(ctx, RepositoryService_ListRepositoryRecords_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RepositoryServiceServer interface {
	...
	ListRepositoryRecords(context.Context, *ListRepositoryRecordsRequest) (*ListRepositoryRecordsResponse, error)
...
func (UnimplementedRepositoryServiceServer) ListRepositoryRecords(context.Context, *ListRepositoryRecordsRequest) (*ListRepositoryRecordsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListRepositoryRecords not implemented")
}
...
func _RepositoryService_ListRepositoryRecords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRepositoryRecordsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RepositoryServiceServer).ListRepositoryRecords(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RepositoryService_ListRepositoryRecords_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServiceServer).ListRepositoryRecords(ctx, req.(*ListRepositoryRecordsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RepositoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListRepositoryRecords",
			Handler:    _RepositoryService_ListRepositoryRecords_Handler,
		},
		{
