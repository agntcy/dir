...
```bash
docker pull ghcr.io/agntcy/dir-ctl:v0.5.6
docker pull ghcr.io/agntcy/dir-apiserver:v0.5.6
```
...
```bash
helm pull oci://ghcr.io/agntcy/dir/helm-charts/dir --version v0.5.6
```
...
```bash
helm pull oci://ghcr.io/agntcy/dir/helm-charts/dir --version v0.5.6
helm upgrade --install dir oci://ghcr.io/agntcy/dir/helm-charts/dir --version v0.5.6
```
