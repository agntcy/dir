...
```bash
docker pull ghcr.io/agntcy/dir-ctl:v1.6.0
docker pull ghcr.io/agntcy/dir-apiserver:v1.6.0
```
...
```bash
helm pull oci://ghcr.io/agntcy/dir/helm-charts/dir --version v1.6.0
```
...
```bash
helm pull oci://ghcr.io/agntcy/dir/helm-charts/dir --version v1.6.0
helm upgrade --install dir oci://ghcr.io/agntcy/dir/helm-charts/dir --version v1.6.0
```
