...
```bash
docker pull ghcr.io/agntcy/dir-ctl:v1.0.0-rc.1
docker pull ghcr.io/agntcy/dir-apiserver:v1.0.0-rc.1
```
...
```bash
helm pull oci://ghcr.io/agntcy/dir/helm-charts/dir --version v1.0.0-rc.1
```
...
```bash
helm pull oci://ghcr.io/agntcy/dir/helm-charts/dir --version v1.0.0-rc.1
helm upgrade --install dir oci://ghcr.io/agntcy/dir/helm-charts/dir --version v1.0.0-rc.1
```
