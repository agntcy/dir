...
func init() {
	...
	flags.StringVar(&clientConfig.AuthMode, "auth-mode", clientConfig.AuthMode, "Authentication mode: x509, jwt, token (SPIFFE), tls, oidc, insecure, none, or empty for auto-detect")
