...
func NegotiateCredentials(ctx context.Context, remoteDirectoryURL string, authnConfig auth.Authn) (*CredentialsResult, error) {
...
func buildClientConfigForRemote(remoteDirectoryURL string, authnConfig auth.Authn) (*client.Config, error) {
