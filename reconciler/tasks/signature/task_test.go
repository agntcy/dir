...
func (f *fakeSignatureDB) GetRecordLabels(cids []string) (map[string][]types.Label, error) {
	return nil, nil
}
...
func (f *fakeSignatureDB) SetRecordPublished(recordCID string, advertised bool) error {
	return nil
}
