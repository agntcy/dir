...
func NewStoreService(config Config) (types.StoreService, error) {
...
// TODO Lookup media/artifact type is also required.
func (s *store) Lookup(ctx context.Context, ref *coretypes.Digest) (*registrytypes.ObjectMeta, error) {
...
func (s *store) Push(ctx context.Context, meta *registrytypes.ObjectMeta, contents io.Reader) (*coretypes.Digest, error) {
