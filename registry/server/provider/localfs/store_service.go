...
func NewStoreService(baseDir string) (types.StoreService, error) {
...
func (c *store) Push(ctx context.Context, meta *registrytypes.ObjectMeta, contents io.Reader) (*coretypes.Digest, error) {
...
func (c *store) Lookup(_ context.Context, dig *coretypes.Digest) (*registrytypes.ObjectMeta, error) {
	...
	// Convert to object
	var metadata registrytypes.ObjectMeta
