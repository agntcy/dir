...
`validate`, `version`, and the local-state install commands (`install agents`,
`install list`, `install pin`, `install unpin`, `install prune`, `uninstall`). Default is `localhost:8888` (local
