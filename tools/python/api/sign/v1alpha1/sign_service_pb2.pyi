...
class SignOIDCRequest(_message.Message):
    ...
    def __init__(self, agent: _Optional[_Union[_agent_pb2.Agent, _Mapping]] = ..., id_token: _Optional[str] = ..., options: _Optional[_Union[SignOIDCRequest.SignOpts, _Mapping]] = ...) -> None: ...

class SignWithKeyRequest(_message.Message):
    __slots__ = ("agent", "private_key", "password")
    AGENT_FIELD_NUMBER: _ClassVar[int]
    ...
    private_key: bytes
    password: bytes
    def __init__(self, agent: _Optional[_Union[_agent_pb2.Agent, _Mapping]] = ..., private_key: _Optional[bytes] = ..., password: _Optional[bytes] = ...) -> None: ...
...
class VerifyOIDCRequest(_message.Message):
    ...
    expected_issuer: str
    expected_signer: str
    def __init__(self, agent: _Optional[_Union[_agent_pb2.Agent, _Mapping]] = ..., expected_issuer: _Optional[str] = ..., expected_signer: _Optional[str] = ...) -> None: ...

class VerifyWithKeyRequest(_message.Message):
    __slots__ = ("agent", "public_key")
    AGENT_FIELD_NUMBER: _ClassVar[int]
    PUBLIC_KEY_FIELD_NUMBER: _ClassVar[int]
    agent: _agent_pb2.Agent
    public_key: bytes
    def __init__(self, agent: _Optional[_Union[_agent_pb2.Agent, _Mapping]] = ..., public_key: _Optional[bytes] = ...) -> None: ...
