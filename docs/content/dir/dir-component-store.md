...
|---------------------|-------------|---------|
| `DIRECTORY_STORE_REGISTRY_ADDRESS` | Registry address | `127.0.0.1:5000` |
| `DIRECTORY_STORE_REPOSITORY_NAME` | Repository name | `dir` |

Credentials are supplied through additional environment variables:

| Environment Variable | Description |
|---------------------|-------------|
| `DIRECTORY_STORE_AUTH_CONFIG_USERNAME` | Username for basic authentication |
| `DIRECTORY_STORE_AUTH_CONFIG_PASSWORD` | Password for basic authentication |
| `DIRECTORY_STORE_AUTH_CONFIG_ACCESS_TOKEN` | Access token for token-based authentication |
| `DIRECTORY_STORE_AUTH_CONFIG_INSECURE` | Skip TLS verification (default: `true`) |
...
```bash
export DIRECTORY_STORE_REGISTRY_ADDRESS=localhost:5000
export DIRECTORY_STORE_REPOSITORY_NAME=dir
export DIRECTORY_STORE_AUTH_CONFIG_INSECURE=true
```

**GitHub Container Registry (GHCR)**

```bash
export DIRECTORY_STORE_REGISTRY_ADDRESS=ghcr.io
export DIRECTORY_STORE_REPOSITORY_NAME=your-org/dir
export DIRECTORY_STORE_AUTH_CONFIG_USERNAME=your-github-username
export DIRECTORY_STORE_AUTH_CONFIG_PASSWORD=your-github-token
export DIRECTORY_STORE_AUTH_CONFIG_INSECURE=false
```
...
```bash
export DIRECTORY_STORE_REGISTRY_ADDRESS=docker.io
export DIRECTORY_STORE_REPOSITORY_NAME=your-username/dir
export DIRECTORY_STORE_AUTH_CONFIG_USERNAME=your-dockerhub-username
export DIRECTORY_STORE_AUTH_CONFIG_PASSWORD=your-dockerhub-token
export DIRECTORY_STORE_AUTH_CONFIG_INSECURE=false
```
