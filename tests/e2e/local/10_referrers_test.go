...
var _ = ginkgo.Describe("Running e2e tests for referrers", func() {
	...
	ginkgo.It("should successfully push basic referrer", func() {
		...
		gomega.Expect(response.GetCid()).NotTo(gomega.BeNil())
		gomega.Expect(response.GetCid().GetCid()).NotTo(gomega.BeEmpty())
	...
	ginkgo.It("should fail if record mismatch", func() {
		...
		gomega.Expect(response.GetCid()).To(gomega.BeNil())
	})
	...
	ginkgo.It("should successfully push & pull referrer stream", func() {
		...
		gomega.Expect(response1.GetCid()).NotTo(gomega.BeNil())
		gomega.Expect(response1.GetCid().GetCid()).NotTo(gomega.BeEmpty())
		...
		gomega.Expect(response2.GetCid()).NotTo(gomega.BeNil())
		gomega.Expect(response2.GetCid().GetCid()).NotTo(gomega.BeEmpty())
		...
		gomega.Expect(response3.GetCid()).To(gomega.BeNil())
