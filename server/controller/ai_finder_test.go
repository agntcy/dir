...
func TestListAgents_DefaultsAndResults(t *testing.T) {
	...
	ctrl := NewAIFinderController("hostId", db, dircfg.HTTPGateway{}, nil)
...
func TestListAgents_Errors(t *testing.T) {
	ctrl := NewAIFinderController("hostId", &fakeCatalogDB{}, dircfg.HTTPGateway{}, nil)
...
func TestWellKnown(t *testing.T) {
	ctrl := NewAIFinderController("hostId-name", &fakeCatalogDB{}, dircfg.HTTPGateway{}, nil)
...
func TestExportAgent_Success(t *testing.T) {
	...
	ctrl := NewAIFinderController("hostId", &fakeCatalogDB{}, dircfg.HTTPGateway{}, store)
