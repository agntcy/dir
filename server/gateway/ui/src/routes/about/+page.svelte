...
<main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
	<header class="mb-8">
		<h1 class="font-display text-3xl font-bold text-ink-strong">About</h1>
		<p class="mt-2 text-ink-medium">
			A short guide to the specifications and directory services this browser is built on.
			Each section below links to the draft or documentation for that piece of the stack.
		</p>
	</header>
	...
	<div class="space-y-8">
		<section class="bg-surface-light rounded-card border border-line/70 shadow-card p-6">
			...
			<p class="mt-3 text-sm text-ink leading-relaxed">
				The spec defines conformance levels from minimal entry lists to trusted catalogs with optional
				trust manifests for identity, attestations, and signatures. This browser surfaces public records
				that follow the AI Catalog model and are published through ADS.
			</p>
			<ul class="mt-4 space-y-2 text-sm">
				<li>
					<a
						href="https://agent-card.github.io/ai-catalog"
						target="_blank"
		...
		<section class="bg-surface-light rounded-card border border-line/70 shadow-card p-6">
			...
			<ul class="mt-4 space-y-2 text-sm">
				<li>
					<a
						href="https://dir.agntcy.org/latest/"
						target="_blank"
						rel="noopener noreferrer"
						class="text-brand-600 hover:text-brand-700 underline underline-offset-2 rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
					>
						Directory documentation overview
					</a>
				</li>
				<li>
					<a
						href="https://dir.agntcy.org/latest/dir/dir-quickstart/"
						target="_blank"
						rel="noopener noreferrer"
						class="text-brand-600 hover:text-brand-700 underline underline-offset-2 rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
					>
				...
				<li>
					<a
						href="https://datatracker.ietf.org/doc/draft-mp-agntcy-ads"
						target="_blank"
						rel="noopener noreferrer"
						class="text-brand-600 hover:text-brand-700 underline underline-offset-2 rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
					>
						ADS specification (IETF draft)
					</a>
				</li>
			</ul>
		</section>
	...
	<p class="mt-10">
		<a
			href="/"
			class="text-sm font-medium text-brand-600 hover:text-brand-700 rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2"
		>
			← Back to catalog
		</a>
	</p>
