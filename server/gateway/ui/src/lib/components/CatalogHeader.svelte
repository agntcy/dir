...
<header class="bg-surface-light border-b border-line sticky top-0 z-30">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center justify-between gap-4">
		<a href="/" class="flex items-center gap-3 min-w-0 rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2">
			<svg class="h-7 flex-shrink-0" viewBox="0 0 492 112" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
		...
		<div class="flex items-center gap-4 sm:gap-6 flex-shrink-0">
			<a
				href="/about"
				class="text-sm font-medium rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 {isAbout
					? 'text-brand-600'
					: 'text-ink-medium hover:text-brand-600'}"
