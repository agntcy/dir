...
// @generated from protobuf file "objects/v2/extension.proto" (package "objects.v2", syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message objects.v2.Extension
 */
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for objects.v2.Extension.annotations");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message objects.v2.Extension
 */
