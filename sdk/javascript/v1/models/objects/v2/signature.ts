...
// @generated from protobuf file "objects/v2/signature.proto" (package "objects.v2", syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message objects.v2.Signature
 */
export interface Signature {
    ...
    /**
     * Signing timestamp of the agent record in the RFC3339 format.
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for objects.v2.Signature.annotations");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message objects.v2.Signature
 */
