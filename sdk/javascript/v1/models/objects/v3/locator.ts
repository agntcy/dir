...
// @generated from protobuf file "objects/v3/locator.proto" (package "objects.v3", syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message objects.v3.Locator
 */
 ...
 *
 * @generated from protobuf enum objects.v3.LocatorType
 */
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for objects.v3.Locator.annotations");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message objects.v3.Locator
 */
