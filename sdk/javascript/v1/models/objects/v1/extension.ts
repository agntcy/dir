...
// @generated from protobuf file "objects/v1/extension.proto" (package "objects.v1", syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message objects.v1.Extension
 */
export interface Extension {
     ...
     * Value of the data.
     *
     * @generated from protobuf field: optional google.protobuf.Struct data = 4
     */
    data?: Struct;
}
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* map<string, string> annotations */ 3:
                    ...
                    break;
                case /* optional google.protobuf.Struct data */ 4:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for objects.v1.Extension.annotations");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message objects.v1.Extension
 */
