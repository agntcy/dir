...
// @generated from protobuf file "objects/v1/locator.proto" (package "objects.v1", syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message objects.v1.Locator
 */
 ...
 *
 * @generated from protobuf enum objects.v1.LocatorType
 */
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for objects.v1.Locator.annotations");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message objects.v1.Locator
 */
