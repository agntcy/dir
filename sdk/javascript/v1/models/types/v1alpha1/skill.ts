...
// @generated from protobuf file "types/v1alpha1/skill.proto" (package "types.v1alpha1", syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message types.v1alpha1.Skill
 */
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for types.v1alpha1.Skill.annotations");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message types.v1alpha1.Skill
 */
