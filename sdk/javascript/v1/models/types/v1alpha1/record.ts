...
// @generated from protobuf file "types/v1alpha1/record.proto" (package "types.v1alpha1", syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message types.v1alpha1.Record
 */
export interface Record {
     ...
     *
     * @generated from protobuf field: repeated types.v1alpha1.Locator locators = 8
     */
    locators: Locator[];
    /**
     * List of skills that the record can perform.
     *
     * @generated from protobuf field: repeated types.v1alpha1.Skill skills = 9
     */
    skills: Skill[];
    /**
     * List of domains under which the record can operate in.
     *
     * @generated from protobuf field: repeated types.v1alpha1.Domain domains = 10
     */
    domains: Domain[];
    /**
     * Additional information attached to the record.
     * Features are used to generically extend the record's functionality.
     *
     * @generated from protobuf field: repeated types.v1alpha1.Feature features = 11
     */
    features: Feature[];
    /**
     * Security signature of the record.
     *
     * @generated from protobuf field: types.v1alpha1.Signature signature = 12
     */
    signature?: Signature;
    /**
...
class Record$Type extends MessageType<Record> {
    constructor() {
        super("types.v1alpha1.Record", [
            ...
            { no: 8, name: "locators", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Locator },
            { no: 9, name: "skills", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Skill },
            { no: 10, name: "domains", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Domain },
            { no: 11, name: "features", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Feature },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for types.v1alpha1.Record.annotations");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    internalBinaryWrite(message: Record, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated types.v1alpha1.Locator locators = 8; */
        for (let i = 0; i < message.locators.length; i++)
            Locator.internalBinaryWrite(message.locators[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
        /* repeated types.v1alpha1.Skill skills = 9; */
        for (let i = 0; i < message.skills.length; i++)
            Skill.internalBinaryWrite(message.skills[i], writer.tag(9, WireType.LengthDelimited).fork(), options).join();
        /* repeated types.v1alpha1.Domain domains = 10; */
        for (let i = 0; i < message.domains.length; i++)
            Domain.internalBinaryWrite(message.domains[i], writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* repeated types.v1alpha1.Feature features = 11; */
        for (let i = 0; i < message.features.length; i++)
            Feature.internalBinaryWrite(message.features[i], writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        /* types.v1alpha1.Signature signature = 12; */
        if (message.signature)
            Signature.internalBinaryWrite(message.signature, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message types.v1alpha1.Record
 */
