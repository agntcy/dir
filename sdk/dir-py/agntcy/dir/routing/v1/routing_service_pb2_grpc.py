...
class RoutingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Publish = channel.unary_unary(
                '/agntcy.dir.routing.v1.RoutingService/Publish',
        ...
        self.Unpublish = channel.unary_unary(
                '/agntcy.dir.routing.v1.RoutingService/Unpublish',
                request_serializer=agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.UnpublishRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.Search = channel.unary_stream(
                '/agntcy.dir.routing.v1.RoutingService/Search',
                request_serializer=agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.SearchRequest.SerializeToString,
                response_deserializer=agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.SearchResponse.FromString,
                _registered_method=True)
        self.List = channel.unary_stream(
                '/agntcy.dir.routing.v1.RoutingService/List',
                request_serializer=agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.ListRequest.SerializeToString,
                response_deserializer=agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.ListResponse.FromString,
                _registered_method=True)
...
def add_RoutingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Unpublish': grpc.unary_unary_rpc_method_handler(
                    servicer.Unpublish,
                    request_deserializer=agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.UnpublishRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'Search': grpc.unary_stream_rpc_method_handler(
                    servicer.Search,
                    request_deserializer=agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.SearchRequest.FromString,
                    response_serializer=agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.SearchResponse.SerializeToString,
            ),
            'List': grpc.unary_stream_rpc_method_handler(
                    servicer.List,
                    request_deserializer=agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.ListRequest.FromString,
                    response_serializer=agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.ListResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'agntcy.dir.routing.v1.RoutingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('agntcy.dir.routing.v1.RoutingService', rpc_method_handlers)
...
class RoutingService(object):
    ...
    def Unpublish(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/agntcy.dir.routing.v1.RoutingService/Unpublish',
            agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.UnpublishRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def Search(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/agntcy.dir.routing.v1.RoutingService/Search',
            agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.SearchRequest.SerializeToString,
            agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.SearchResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def List(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/agntcy.dir.routing.v1.RoutingService/List',
            agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.ListRequest.SerializeToString,
            agntcy_dot_dir_dot_routing_dot_v1_dot_routing__service__pb2.ListResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
