...
type StoreServiceClient interface {
	...
	// All fields on the Object must be set.
	// Data is sent in chunks, and empty value indicates end of the stream.
	// Enables data synchroization between two store services.
	...
	// Data is returned in chunks, and empty value indicates end of the stream.
	// Enables data synchroization between two store services.
