...
// PushSignatureRequest is used to store a pre-generated signature for a record
type PushSignatureRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Record reference that this signature is for
	RecordRef *v1.RecordRef `protobuf:"bytes,1,opt,name=record_ref,json=recordRef,proto3" json:"record_ref,omitempty"`
...
func (x *PushSignatureRequest) Reset() {
	*x = PushSignatureRequest{}
	mi := &file_sign_v1_sign_service_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PushSignatureRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PushSignatureRequest) ProtoMessage() {}

func (x *PushSignatureRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sign_v1_sign_service_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PushSignatureRequest.ProtoReflect.Descriptor instead.
func (*PushSignatureRequest) Descriptor() ([]byte, []int) {
	return file_sign_v1_sign_service_proto_rawDescGZIP(), []int{8}
}

func (x *PushSignatureRequest) GetRecordRef() *v1.RecordRef {
	if x != nil {
		return x.RecordRef
	}
	return nil
...
func (x *PushSignatureRequest) GetSignature() *Signature {
	if x != nil {
		return x.Signature
	}
	return nil
...
// PushSignatureResponse confirms successful signature storage
type PushSignatureResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Indicates if the signature was successfully stored
	Success bool `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	// Optional error message if storage failed
	ErrorMessage  *string `protobuf:"bytes,2,opt,name=error_message,json=errorMessage,proto3,oneof" json:"error_message,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PushSignatureResponse) Reset() {
	*x = PushSignatureResponse{}
	mi := &file_sign_v1_sign_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PushSignatureResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PushSignatureResponse) ProtoMessage() {}

func (x *PushSignatureResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sign_v1_sign_service_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PushSignatureResponse.ProtoReflect.Descriptor instead.
func (*PushSignatureResponse) Descriptor() ([]byte, []int) {
	return file_sign_v1_sign_service_proto_rawDescGZIP(), []int{9}
}

func (x *PushSignatureResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *PushSignatureResponse) GetErrorMessage() string {
	if x != nil && x.ErrorMessage != nil {
		return *x.ErrorMessage
	}
	return ""
...
// PullSignatureRequest is used to retrieve a signature for a record
type PullSignatureRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Record reference to retrieve signature for
	RecordRef     *v1.RecordRef `protobuf:"bytes,1,opt,name=record_ref,json=recordRef,proto3" json:"record_ref,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PullSignatureRequest) Reset() {
	*x = PullSignatureRequest{}
	mi := &file_sign_v1_sign_service_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PullSignatureRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PullSignatureRequest) ProtoMessage() {}

func (x *PullSignatureRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sign_v1_sign_service_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PullSignatureRequest.ProtoReflect.Descriptor instead.
func (*PullSignatureRequest) Descriptor() ([]byte, []int) {
	return file_sign_v1_sign_service_proto_rawDescGZIP(), []int{10}
}

func (x *PullSignatureRequest) GetRecordRef() *v1.RecordRef {
	if x != nil {
		return x.RecordRef
	}
	return nil
...
// PullSignatureResponse returns the signature for a record
type PullSignatureResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The signature for the record (null if not found)
	Signature *Signature `protobuf:"bytes,1,opt,name=signature,proto3,oneof" json:"signature,omitempty"`
	// Indicates if a signature was found
	Found         bool `protobuf:"varint,2,opt,name=found,proto3" json:"found,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PullSignatureResponse) Reset() {
	*x = PullSignatureResponse{}
	mi := &file_sign_v1_sign_service_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PullSignatureResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PullSignatureResponse) ProtoMessage() {}

func (x *PullSignatureResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sign_v1_sign_service_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PullSignatureResponse.ProtoReflect.Descriptor instead.
func (*PullSignatureResponse) Descriptor() ([]byte, []int) {
	return file_sign_v1_sign_service_proto_rawDescGZIP(), []int{11}
}

func (x *PullSignatureResponse) GetSignature() *Signature {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *PullSignatureResponse) GetFound() bool {
	if x != nil {
		return x.Found
	}
	return false
...
func (x *SignWithOIDC_SignOpts) Reset() {
	*x = SignWithOIDC_SignOpts{}
	mi := &file_sign_v1_sign_service_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_sign_v1_sign_service_proto_rawDesc = string([]byte{
	...
	,
	...
	,
...
var file_sign_v1_sign_service_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_sign_v1_sign_service_proto_goTypes = []any{
	...
	(*PushSignatureRequest)(nil),  // 8: sign.v1.PushSignatureRequest
	(*PushSignatureResponse)(nil), // 9: sign.v1.PushSignatureResponse
	(*PullSignatureRequest)(nil),  // 10: sign.v1.PullSignatureRequest
	(*PullSignatureResponse)(nil), // 11: sign.v1.PullSignatureResponse
	(*SignWithOIDC_SignOpts)(nil), // 12: sign.v1.SignWithOIDC.SignOpts
	nil,                           // 13: sign.v1.Signature.AnnotationsEntry
	(*v1.RecordRef)(nil),          // 14: core.v1.RecordRef
}
var file_sign_v1_sign_service_proto_depIdxs = []int32{
	14, // 0: sign.v1.SignRequest.record_ref:type_name -> core.v1.RecordRef
	...
	12, // 4: sign.v1.SignWithOIDC.options:type_name -> sign.v1.SignWithOIDC.SignOpts
	7,  // 5: sign.v1.SignResponse.signature:type_name -> sign.v1.Signature
	14, // 6: sign.v1.VerifyRequest.record_ref:type_name -> core.v1.RecordRef
	13, // 7: sign.v1.Signature.annotations:type_name -> sign.v1.Signature.AnnotationsEntry
	14, // 8: sign.v1.PushSignatureRequest.record_ref:type_name -> core.v1.RecordRef
	7,  // 9: sign.v1.PushSignatureRequest.signature:type_name -> sign.v1.Signature
	14, // 10: sign.v1.PullSignatureRequest.record_ref:type_name -> core.v1.RecordRef
	7,  // 11: sign.v1.PullSignatureResponse.signature:type_name -> sign.v1.Signature
	0,  // 12: sign.v1.SignService.Sign:input_type -> sign.v1.SignRequest
	8,  // 13: sign.v1.SignService.PushSignature:input_type -> sign.v1.PushSignatureRequest
	10, // 14: sign.v1.SignService.PullSignature:input_type -> sign.v1.PullSignatureRequest
	5,  // 15: sign.v1.SignService.Verify:input_type -> sign.v1.VerifyRequest
	4,  // 16: sign.v1.SignService.Sign:output_type -> sign.v1.SignResponse
	9,  // 17: sign.v1.SignService.PushSignature:output_type -> sign.v1.PushSignatureResponse
	11, // 18: sign.v1.SignService.PullSignature:output_type -> sign.v1.PullSignatureResponse
	6,  // 19: sign.v1.SignService.Verify:output_type -> sign.v1.VerifyResponse
...
func file_sign_v1_sign_service_proto_init() {
	...
	file_sign_v1_sign_service_proto_msgTypes[9].OneofWrappers = []any{}
	file_sign_v1_sign_service_proto_msgTypes[11].OneofWrappers = []any{}
	file_sign_v1_sign_service_proto_msgTypes[12].OneofWrappers = []any{}
	type x struct{}
