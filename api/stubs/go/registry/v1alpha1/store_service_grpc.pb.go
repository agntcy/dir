...
const (
	StoreService_Push_FullMethodName   = "/registry.v1alpha1.StoreService/Push"
	StoreService_Pull_FullMethodName   = "/registry.v1alpha1.StoreService/Pull"
	StoreService_Lookup_FullMethodName = "/registry.v1alpha1.StoreService/Lookup"
	StoreService_Delete_FullMethodName = "/registry.v1alpha1.StoreService/Delete"
)
...
// service for service-specific models and arbitrary
// data such as blobs, files, etc.
//
...
var StoreService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "registry.v1alpha1.StoreService",
	...
	Metadata: "registry/v1alpha1/store_service.proto",
}
