...
const (
	PublishService_Publish_FullMethodName   = "/registry.v1alpha1.PublishService/Publish"
	PublishService_Unpublish_FullMethodName = "/registry.v1alpha1.PublishService/Unpublish"
	PublishService_Resolve_FullMethodName   = "/registry.v1alpha1.PublishService/Resolve"
)
...
type PublishServiceClient interface {
	...
	Resolve(ctx context.Context, in *Record, opts ...grpc.CallOption) (*ObjectRef, error)
}
...
func (c *publishServiceClient) Resolve(ctx context.Context, in *Record, opts ...grpc.CallOption) (*ObjectRef, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ObjectRef)
...
type PublishServiceServer interface {
	...
	// Resolve performs lookup operation for the requested record
	// and returns associated object reference.
	Resolve(context.Context, *Record) (*ObjectRef, error)
}
...
func (UnimplementedPublishServiceServer) Resolve(context.Context, *Record) (*ObjectRef, error) {
...
var PublishService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "registry.v1alpha1.PublishService",
	...
	Metadata: "registry/v1alpha1/publish_service.proto",
}
